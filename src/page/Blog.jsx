...
const Blog = () => {
    return (
        <div className="max-w-7xl mx-auto px-4 ">
            ...
            <h1 className=" text-5xl font-bold text-black pb-4">OUR LATEST BLOG & ARTICLES</h1>
            <p className="max-w-4xl mx-auto">Whether you are looking for breaking news, in-depth analysis, or simply want to connect with like-minded fans, sports blogs are your go-to source for all things sports-related.</p>
            </div>
  ...
  <div className="card-body lg:w-2/3">
    ...
    <p>The beauty of sports events lies in their diversity. Each sport presents its own unique challenges and showcases extraordinary talents. From the finesse of tennis to the raw power of football, these events inspire athletes to dedicate themselves fully, pushing the boundaries of human potential.</p>
         ...
         <div data-aos="zoom-in-up" data-aos-duration="1500" className="card  lg:card-side bg-base-100 shadow-xl">
  ...
  <div className="card-body lg:w-2/3">
    ...
    <p>Sports events are more than just games; they are a source of community and familial bonding. Fans from all walks of life come together, creating an electric atmosphere of unity and support. Tailgating, chants, and shared victories and defeats forge lasting connections that extend beyond the arena.
  ...
  <div className="card-body lg:w-2/3">
    ...
    <p>Beyond their emotional impact, sports events also hold significant economic importance. They generate revenue through ticket sales, merchandise, sponsorships, and tourism. Host cities benefit from the influx of visitors, boosting local economies, and creating jobs. In this way, sports events enrich not only our hearts but also our communities and wallets.</p>
  </div>
</div>
         </div>
        </div>
