import { FaTwitter,FaSquareFacebook, FaInstagram } from "react-icons/fa6";
...
const OurTeam = () => {
    return (
        ...
        <div className="relative grid h-[40vh] w-full grid-cols-1 place-items-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
          ...
          <div className="relative p-6 py-14 px-6 md:px-12">
            <h2 className="block font-sans text-7xl font-medium leading-[1.5] tracking-normal text-cyan-500 antialiased">
              Our Team
            </h2>
            <p className="text-cyan-50 max-w-5xl">Our sports team management is committed to success, focusing on skill development, strategic planning, and fostering teamwork. We aim to create a winning atmosphere both on and off the field, uniting athletes, and fans in our pursuit of excellence.</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto p-2 mt-14">
  ...
  <div className="p-6 text-center">
    ...
    <p className="block bg-gradient-to-tr from-cyan-400 to-black bg-clip-text font-sans text-base font-medium leading-relaxed text-transparent antialiased">
      CEO / Co-Founder
    </p>
  </div>
